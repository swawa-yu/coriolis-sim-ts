...
const Animation1: React.FC<Animation1Props> = ({ position, initialPosition, earthRotation, isRunning, globalTimeRef }) => {
    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            earth.rotation.y = degreeToRadian(earthRotation);
    ...
    return <div id="animation1" ref={containerRef}></div>;
};
